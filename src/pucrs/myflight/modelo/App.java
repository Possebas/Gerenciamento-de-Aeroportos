...
//            System.exit(1);
		...
		*/
        ...
        try {
			...
			System.out.println("Não foi possível ler aeronaves!");
			//System.exit(1)//;
		}
		...
		//gerAvioes.ordenarCodigoDescricao();

		//gerAvioes.ordenarCodigo();
		// Listando em ordem alfabética de código desempate descrição:
		/*
		System.out.println("\nAeronaves:");
		for(Aeronave av: todasAeronaves) {
			System.out.println(av.getCodigo()+" - "+av.getDescricao()+" - "+av.getCapacidade());
		}
//       gerAvioes.ordenarCodigo();
...
//            System.exit(1);
        ...
        /*
        ArrayList<Aeroporto> todosAeroportos = gerAero.listarTodos();
        System.out.println("Total Aeroporto:"+todosAeroportos.size());
		...
		*/
		...
		try {
			...
			System.out.println("Não foi possível ler rotas");
			//System.exit(1)//;
		}
        ...
        /*
		System.out.println("\nRotas:");
		for(Rota rt: gerRotas.listarTodas()) {
			System.out.println(rt.getCia()+" - "+rt.getOrigem()+" - "+rt.getDestino());
		}
        ...
        for (Rota r: gerRotas.listarTodas()) {
            if(r.getCia().getCodigo().equals("3J")){
                for (Aeroporto a : gerAero.toArray()) {
                    if(r.getOrigem().getCodigo().equals(a.getCodigo())||r.getDestino().getCodigo().equals(a.getCodigo())){
                        desenharAero.add(a);
                    }
                }
            }
        }
        System.out.println(desenharAero.size());
